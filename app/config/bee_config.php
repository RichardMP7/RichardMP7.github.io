...
define('BASEPATH'   , IS_LOCAL ? '/proyecto01/proyecto01/' : '____EL BASEPATH EN PRODUCCIÓN___');
...
define('PORT'       , '80');
define('URL'        , IS_LOCAL ? 'http://127.0.0.1:'.PORT.'/proyecto01/proyecto01/' : '___URL EN PRODUCCIÓN___');
